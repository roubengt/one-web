    ...
    <div style={{ backgroundColor: BG, color: 'white', overflowX: 'hidden' }}>
      ...
      <div style={{ position: 'fixed', top: 0, left: menuAbierto ? 0 : '-100%', width: '300px', height: '100vh', backgroundColor: '#060606', borderRight: `1px solid ${BORDER}`, zIndex: 999, transition: 'left 0.4s cubic-bezier(0.4, 0, 0.2, 1)', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '48px' }}>
        ...
        <div style={{ marginTop: '48px', display: 'flex', gap: '24px' }}>
          {[{ href: 'https://www.facebook.com/oneevolution.cl/', label: 'FB' }, { href: 'https://www.instagram.com/oneevolution.cl', label: 'IG' }, { href: 'https://wa.me/56956723743', label: 'WA' }].map(r => (
            <a key={r.href} href={r.href} target="_blank" rel="noreferrer" style={{ ...B, color: '#aaa', fontSize: '11px', letterSpacing: '2px', fontWeight: 500, textDecoration: 'none', transition: 'color 0.2s' }}
